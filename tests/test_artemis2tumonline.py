...
class BasicTest(TestCase):
    ...
    def test_normal(self) -> None:
        ...
        :return:
        """
        result = self.runner.invoke(app, ["create-final-results","--tumonline-registration-file", "tests/rsc/test_registration_file.csv",
    ...
    def test_no_artemis_entry(self) -> None:
        ...
        result = self.runner.invoke(app, ["create-final-results", "--tumonline-registration-file", "tests/rsc/test_missing_id.csv",
                                          "--artemis-export-file", "tests/rsc/test_artemis_export.csv"])
